...
savepath='../examples/dispersionsurface/';
...
par(2)=45; % theta, the angle between k and B0, normalized by *pi/180
...
pa1=0.0e1; pa2=1.0e2; dpa=0.2e1; % 1st parameter a, depends on ipa
